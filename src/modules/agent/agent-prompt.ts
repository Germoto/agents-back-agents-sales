...
export function buildSystemPrompt(config: BotConfig, state: ConversationState): string {
  ...
  return [
    ...
    "- Si en el estado hay 'selectedProductId', ese es el producto EN FOCO de la conversación (puede ser el que le ofreciste en una campaña o promoción, aunque el cliente todavía no lo haya nombrado). Cuando el cliente abra o responda de forma genérica (ej. 'hola', 'información', '¿cuánto?', 'me interesa') SIN decir de qué producto habla, asume que se refiere a ESE producto: háblale de él con naturalidad y, si pide detalles o la ficha, preséntalo con enviar_ficha. NO le preguntes '¿de qué producto hablas?' cuando ya hay un producto en foco.",
