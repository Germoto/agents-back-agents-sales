...
import { createProductController, deleteProductController, getProductController, listProductsController, toggleProductActiveController, toggleProductCatalogController, updateProductController } from "./products.controller";
